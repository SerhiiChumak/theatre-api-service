...
from theatre.models import Genre, Actor, TheatreHall, Play, PlaySession, Reservation
    ...
    @extend_schema(
        parameters=[
            ...
            OpenApiParameter(
                ...
                description=(
                    "Filter by datetime of PlaySession"
                    "(ex. ?date=2022-10-23)"
                ),
            ),
        ]
...
class ReservationViewSet(
    ...
    queryset = Reservation.objects.prefetch_related(
        "tickets__play_session__play", "tickets__play_session__theatre_hall"
    )
