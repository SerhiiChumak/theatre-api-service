...
from theatre.models import Play, PlaySession, TheatreHall, Genre, Actor
from theatre.serializers import PlayListSerializer, PlayDetailSerializer

PLAY_URL = reverse("theatre:play-list")
PLAY_SESSION_URL = reverse("theatre:playsession-list")
...
def sample_play_session(**params):
    ...
    return PlaySession.objects.create(**defaults)
