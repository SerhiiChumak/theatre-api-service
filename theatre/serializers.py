...
class PlaySessionListSerializer(PlaySessionSerializer):
...
class TicketSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Ticket
        fields = ("id", "row", "seat", "play_session")


class TicketListSerializer(TicketSerializer):
    movie_session = PlaySessionListSerializer(many=False, read_only=True)
...
class PlaySessionDetailSerializer(PlaySessionSerializer):
